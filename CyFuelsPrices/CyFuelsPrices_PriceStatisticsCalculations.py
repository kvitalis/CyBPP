...
# Read necessary data
df = pd.read_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ScrapedData.csv")
urls = pd.read_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ProductsList.csv")

# Create a null dataframe
daily_errors = pd.DataFrame(columns = ["Name","Subclass","Url","Division","Retailer"])
scraped_data = pd.DataFrame(columns = ["Date","Name","Price","Subclass","Division","Retailer"])
...
df.to_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ScrapedData.csv", index = False) 

combined_df = pd.concat([df, scraped_data], axis = 0)
combined_df.reset_index(drop = True, inplace = True)
combined_df.to_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ScrapedData.csv", index = False, header = True)
daily_errors.to_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_DailyScrapingErrors.csv", index = False)
