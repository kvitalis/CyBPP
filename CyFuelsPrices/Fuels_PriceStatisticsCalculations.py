...
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded95.CyprusAverage'], label='Unleaded 95 - Cyprus Average', marker='-',  linestyle='-', color='red')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded98.CyprusAverage'], label='Unleaded 98 - Cyprus Average', marker='-', linestyle='-', color='blue')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Diesel.CyprusAverage'], label='Diesel - Cyprus Average',   marker='-', linestyle='-',color='black')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['HeatingDiesel.CyprusAverage'], label='Heating Diesel - Cyprus Average',  marker='-', linestyle='-', color='brown')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Kerosene.CyprusAverage'], label='Kerosene - Cyprus Average', marker='-', linestyle='-', color='green')
plt.xlabel('Date')
plt.ylabel('Price (€/L)')
...
plt.figure(figsize=(12, 6))
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded95.CyprusMin'], label='Unleaded 95 - Cyprus Minimum', marker='-', linestyle='-', color='red')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded98.CyprusMin'], label='Unleaded 98 - Cyprus Minimum', marker='-', linestyle='-', color='blue')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Diesel.CyprusMin'], label='Diesel - Cyprus Minimum', marker='-', linestyle='-', color='black')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['HeatingDiesel.CyprusMin'], label='Heating Diesel - Cyprus Minimum', marker='-',  linestyle='-', color='brown')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Kerosene.CyprusMin'], label='Kerosene - Cyprus Minimum', marker='-', linestyle='-', color='green')
plt.xlabel('Date')
plt.ylabel('Price (€/L)')
...
plt.figure(figsize=(12, 6))
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded95.CyprusMax'], label='Unleaded 95 - Cyprus Maximum', marker='-', linestyle='-', color='red')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded98.CyprusMax'], label='Unleaded 98 - Cyprus Maximum', marker='-', linestyle='-', color='blue')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Diesel.CyprusMax'], label='Diesel - Cyprus Maximum', marker='-', linestyle='-', color='black')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['HeatingDiesel.CyprusMax'], label='Heating Diesel - Cyprus Maximum',marker='-',  linestyle='-', color='brown')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Kerosene.CyprusMax'], label='Kerosene - Cyprus Maximum', marker='-', linestyle='-', color='green')
plt.xlabel('Date')
plt.ylabel('Price (€/L)')
...
plt.figure(figsize=(12, 6))
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded95.CyprusMedian'], label='Unleaded 95 - Cyprus Median',marker='-',  linestyle='-', color='red')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Unleaded98.CyprusMedian'], label='Unleaded 98 - Cyprus Median', marker='-', linestyle='-', color='blue')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Diesel.CyprusMedian'], label='Diesel - Cyprus Median',marker='-',  linestyle='-', color='black')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['HeatingDiesel.CyprusMedian'], label='Heating Diesel - Cyprus Median',marker='-',  linestyle='-', color='brown')
plt.plot(fuels_prices_stats['Date'], fuels_prices_stats['Kerosene.CyprusMedian'], label='Kerosene - Cyprus Median',marker='-',  linestyle='-', color='green')
plt.xlabel('Date')
plt.ylabel('Price (€/L)')
