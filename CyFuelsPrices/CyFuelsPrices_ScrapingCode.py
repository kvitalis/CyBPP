...
# Read necessary data
df = pd.read_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ScrapedData-Copy.csv")
urls = pd.read_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ProductsList-Copy.csv")
...
df.to_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ScrapedData-Copy.csv", index = False) 

combined_df = pd.concat([df, scraped_data], axis = 0)
combined_df.reset_index(drop = True, inplace = True)
combined_df.to_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_ScrapedData-Copy.csv", index = False, header = True)
daily_errors.to_csv("C:/Users/kvital01/OneDrive - University of Cyprus/Desktop/CyBPP_GitHub/FuelDaddy/Popular_locations/FuelDaddy_Popular_DailyScrapingErrors-Copy.csv", index = False)
