...
raw_data = raw_data[~(raw_data["Suclass"]=="Products for pets")] #exclude these retailers' data 
...
while today_p <= end_date:
    ...
    #Call the function
    if is_last_thursday(today_p):
        df_current_date = df_daily_general[df_daily_general["Date"] == today_f]
