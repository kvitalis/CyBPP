...
plt.grid(True)
plt.tight_layout()
plt.savefig('Results/Daily-Plots/Daily-Inflation.png')
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('Results/Daily-Plots/Daily-CPI-General.png')
plt.show()
...
if is_last_thursday(current_date):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('Results/Monthly-Plots/Monthly-Inflation.png')
    plt.show()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('Results/Monthly-Plots/Monthly-CPI-General.png')
    plt.show()
else:
    pass
